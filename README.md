...
Позвольте представить Gym Locker Optimizer (Оптимизатор шкафчиков в фитнес-клубе) - privacy-friendly алгоритм распределения шкафчиков для фитнес-клубов, тренажерных залов, бассейнов и раздевалок. Проект сделал Олег Ремизов, сайт: [remizov.com](https://remizov.com).

Моя идея простая, появилась так как лично сталкивался в двух фитнес-клубах в Москве. Когда посетитель приходит в клуб, система выбирает свободный шкафчик не случайно, а с учетом физической карты раздевалки, текущей занятости и вероятного времени ухода других посетителей. Цель моя это снизить ситуации, когда людям приходится переодеваться рядом друг с другом когда приходишь в зал или когда уже завершил тренировку.
